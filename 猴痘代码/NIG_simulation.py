...
def save_NIG_plot_data(s, NIG, delt_IG, excel_dir='北京数据'):
    ...
    # 保存为excel文件
    excel_file_path = os.path.join(excel_dir, 'NIG_北京.xlsx')
...
def main():
    ...
    print("保存NIG绘图数据...")
    save_NIG_plot_data(s, NIG, delt_IG, excel_dir='北京数据')
